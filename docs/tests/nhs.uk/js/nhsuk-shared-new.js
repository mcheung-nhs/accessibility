...
;(function($) {
  ...
  var surveyBannerStr = "<div id='nhsuk-feedback-banner' class='nhsuk-c-feedback-banner'>" +
        ...
        "<div class='nhsuk-o-grid'>" +
            "<div class='nhsuk-o-grid__item nhsuk-o-grid__item--full'>" +
              "<div class='nhsuk-c-feedback-banner__content'>" + 
                "<h2 class='nhsuk-c-feedback-banner__header'>[Invitation1]</h2>" +
                "<p class='nhsuk-c-feedback-banner__message'>[Invitation2] <a id='AgreeButton' class='wrap'>Take our short survey</a></p>" +
                "<a id='DisagreeButton' class='nhsuk-c-feedback-banner__close'><span role='text'>Close<span class='visually-hidden'> feedback invite</span></span></a>" +
                "</div>" +
            "</div>" +
        "</div>" +
      "</div>";
  
    var alertBannerStr = "<div id='nhsuk-global-alert' class='nhsuk-c-global-alert'>" +
      "<div class='nhsuk-o-width-container'>" +
        "<div class='nhsuk-o-grid'>" +
          "<div class='nhsuk-o-grid__item nhsuk-o-grid__item--full'>" +
            "<div class='nhsuk-c-global-alert__content'>" +
              "[Content]" +
              "<p id='last-updated' class='nhsuk-c-global-alert__updated'></p>" +
            "</div>" +
          "</div>" +
        "</div>" +
      "</div>" +
  ...
  var alphaBannerStr = "<div id='BannerDisplay' class='alpha-banner-wrap clear'>" +
      "<div id='AlphaBanner' class='alpha-visit-content'>" +
      "<div class='survey-invite'>" +
      "<p><span>[Invitation1]</span></p>" +
      "<p>[Invitation2]</p>" +
      "</div>" +
      "<ul>" +
      "<li class='leave-feedback agree'><a id='AgreeButton' class='agree' onclick='dcsMultiTrack(&quot;DCSext.BetaInvite&quot;,&quot;Yes&quot;,&quot;WT.dl&quot;,&quot;121&quot;)'>[Agree]</a></li>" +
      "<li class='go-back postpone'><a id='PostponeButton' class='postpone' onclick='dcsMultiTrack(&quot;DCSext.BetaInvite&quot;,&quot;Maybe Later&quot;,&quot;WT.dl&quot;,&quot;121&quot;)'>[Postpone]</a></li>" +
      "<li class='go-back disagree'><a id='DisagreeButton' class='disagree' onclick='dcsMultiTrack(&quot;DCSext.BetaInvite&quot;,&quot;No&quot;,&quot;WT.dl&quot;,&quot;121&quot;)'>[Disagree]</a></li>" +
      "</ul>" +
      "</div>" +
      "</div>";
  ...
  function ProcessBanners(bannersArray) {
      ...
      if (foundBanner) {
          ...
          insertBanner(banner, $bannerEl, banner.CreatedDate);
  ...
  function insertBanner(banner, $bannerEl, CreatedDate) {
      if (banner.Style === "Alert") {
          $("#c-nav-primary").after($bannerEl);
          var dateISO = new Date(CreatedDate);
          var date = dateISO.toLocaleDateString(); 
          var time = dateISO.toLocaleTimeString();
          $("#last-updated").html("Last updated on: " + date + " at " + time);
      }
      else {
          $("footer").after($bannerEl);
          if ($("#nhsuk-feedback-banner").length) {
            $("#nhsuk-feedback-banner").delay(3000).show(0);
          }
      }
  }
...
;$( document ).ready(function() {
  $(".nhsuk-a-z-list > ul > li > a").click(function(event){
    var href = $(this).attr('href'),
        hrefLocation = href.substring(href.length - 2);
    event.preventDefault();
    $(hrefLocation).attr('tabindex', -1).on('blur focusout', function () {
      $(this).removeAttr('tabindex');
    }).focus();
  });
});
  ...
  var render = function() {
    $items.each(function(i, item) {
      ...
      if (state.openIndex === i ) {
        ...
        $item.find('> a').addClass('livewell-nav__label--selected');
      } else {
        $item.removeClass('livewell-nav__item--selected')
        $item.find('> a').removeClass('livewell-nav__label--selected');
      }

      $item.find('.livewell-nav-subnav__item').each(function(j) {
        if (state.openSubTabs[i][j]) {
          $(this).addClass('livewell-nav-subnav__item--open');
          $(this).find('> a').addClass('livewell-nav-subnav__label--selected');
        } else {
          $(this).removeClass('livewell-nav-subnav__item--open');
          $(this).find('> a').removeClass('livewell-nav-subnav__label--selected');
        }
      })
    })
  ...
  $items.each(function(i, item) {
    $(item).find('> a').on('click', function(e) {
      ...
      var $this = $(this),
          ...
          labelClass = 'livewell-nav__label--selected';

      if ($this.hasClass(labelClass)) {
        $this.attr('aria-label', label + ', select to expand');
      } else {
        $this.attr('aria-label', label + ', expanded');
      }
    ...
    $(item).find('.livewell-nav-subnav__item').each(function(j) {
      ...
      $subitem.find('> a').on('click', function(e) {
        ...
        var $this = $(this),
            label = $.trim($this.text()),
            labelClass = 'livewell-nav-subnav__label--selected';
