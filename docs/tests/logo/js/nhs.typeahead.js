      ...
      templates: {
        ...
        suggestion: function(data){
          ...
          switch (data.action_t) {
            case 'Q':
              displayitem = '<li><svg class="nhsuk-icon nhsuk-icon__search" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true"><path d="M19.71 18.29l-4.11-4.1a7 7 0 1 0-1.41 1.41l4.1 4.11a1 1 0 0 0 1.42 0 1 1 0 0 0 0-1.42zM5 10a5 5 0 1 1 5 5 5 5 0 0 1-5-5z"/><image class="nhsuk-icon__search nhsuk-icon__search--fallback" src="img/icons/icon-search-blue.png" xlink:href=""></svg><a href="' + searchUrl + '&query=' + data.action + '">' + displayitem + '</a></li>';
              break;
            case 'E':
              displayitem = '<li><svg class="nhsuk-icon nhsuk-icon__search" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true"><path d="M19.71 18.29l-4.11-4.1a7 7 0 1 0-1.41 1.41l4.1 4.11a1 1 0 0 0 1.42 0 1 1 0 0 0 0-1.42zM5 10a5 5 0 1 1 5 5 5 5 0 0 1-5-5z"/><image class="nhsuk-icon__search nhsuk-icon__search--fallback" src="img/icons/icon-search-blue.png" xlink:href=""></svg><a href="' + searchUrl + '&query=' + data.key + '&' + data.action + '">' + displayitem + '</a></li>';
              break;
            case 'U':
              displayitem = '<li><svg class="nhsuk-icon nhsuk-icon__search" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true"><path d="M19.71 18.29l-4.11-4.1a7 7 0 1 0-1.41 1.41l4.1 4.11a1 1 0 0 0 1.42 0 1 1 0 0 0 0-1.42zM5 10a5 5 0 1 1 5 5 5 5 0 0 1-5-5z"/><image class="nhsuk-icon__search nhsuk-icon__search--fallback" src="img/icons/icon-search-blue.png" xlink:href=""></svg><a href="' + data.action + '">' + displayitem + '</a></li>';
              break;
            case 'C':
              displayitem = '<li><svg class="nhsuk-icon nhsuk-icon__search" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true"><path d="M19.71 18.29l-4.11-4.1a7 7 0 1 0-1.41 1.41l4.1 4.11a1 1 0 0 0 1.42 0 1 1 0 0 0 0-1.42zM5 10a5 5 0 1 1 5 5 5 5 0 0 1-5-5z"/><image class="nhsuk-icon__search nhsuk-icon__search--fallback" src="img/icons/icon-search-blue.png" xlink:href=""></svg><a href="#" onClick="' + data.action + '">'  + displayitem + '</a></li>';
              break;
            default:
              displayitem = '<li><svg class="nhsuk-icon nhsuk-icon__search" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true"><path d="M19.71 18.29l-4.11-4.1a7 7 0 1 0-1.41 1.41l4.1 4.11a1 1 0 0 0 1.42 0 1 1 0 0 0 0-1.42zM5 10a5 5 0 1 1 5 5 5 5 0 0 1-5-5z"/><image class="nhsuk-icon__search nhsuk-icon__search--fallback" src="img/icons/icon-search-blue.png" xlink:href=""></svg><a href="' + searchUrl + '&query=' + data.disp + '">' + displayitem + '</a></li>';
              break;
